...
const leads = [
  { initials: "VP", name: "Vinay Punganoor", child: "Saakshi", time: "Evenings 6–9 PM IST", score: 100, tags: ["HOT", "ACTIONABLE"], avatarBg: "bg-indigo-100 text-indigo-700" },
...
const tagStyle: Record<string, string> = {
  ...
  ACTIONABLE: "bg-indigo-50 text-indigo-700",
...
export default function Hero() {
  return (
    <section id="features" className="max-w-6xl mx-auto px-6 pt-10 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-200 text-indigo-700 text-xs font-bold uppercase tracking-widest mb-6">
        ...
        <h1 className="text-4xl sm:text-5xl xl:text-[53px] font-bold text-gray-900 leading-[1.1] tracking-tight mb-5">
          ...
          <br />
          <span className="text-indigo-600">Every rupee, tracked.</span>
        </h1>

        <p className="text-base text-gray-500 leading-relaxed mb-8 max-w-lg">
          LeadFlow gives your entire sales organisation a unified system to capture,
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          <Link
            href="#plans"
            className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors text-[15px]"
          >
            Explore Features
      ...
      <div className="rounded-2xl border border-gray-200 shadow-xl overflow-hidden" style={{ background: "#F8F7F4" }}>
        <div className="p-5">
          ...
          <div className="flex items-center justify-between mb-4">
            <span className="font-bold text-sm text-gray-900">Lead Queue</span>
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            {[
              { val: "37", label: "Total Leads", color: "text-indigo-600" },
